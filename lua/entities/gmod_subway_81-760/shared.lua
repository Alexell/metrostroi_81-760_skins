...
ENT.PrintName		= "81-760 MVM"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
ENT.Category		= "Metrostroi (trains)"
ENT.Model = "models/metrostroi_train/81-760/81_760_body.mdl"
...
function ENT:InitializeSounds()
	...
	--[[
    self.SoundNames["test_async1"]   = {"subway_Trains/760/inventor_pisk.wav", loop = true}--{"subway_trains/722/engines/inverter_1000.wav",loop = true}
    ...
    self.SoundNames["pneumo_disconnect_close"] = {
		"subway_trains/760/new/013_close1.wav",
		"subway_trains/760/new/013_close2.wav",
	}
    self.SoundNames["pneumo_disconnect_open"] = {
        "subway_trains/760/new/013_open1.wav",
        "subway_trains/760/new/013_open2.wav",
    }
    ...
    self.SoundNames["stopkran_brake"] = {loop=true,"subway_trains/common/pneumatic/autostop_loop.wav"}
    self.SoundPositions["stopkran_brake"] = {600,1e9,Vector(-462.9,-43,-21.5),0.95}	
	
    self.SoundNames["stopkran_open"] = {
        "subway_trains/ezh3/pneumatic/brake_line_on.mp3",
        "subway_trains/ezh3/pneumatic/brake_line_on2.mp3",
    }
    self.SoundNames["stopkran_disconnect"] = {
        "subway_trains/common/334/334_close.mp3",
    }
    self.SoundPositions["stopkran_open"] = {60,1e9,Vector(-462.9,-43,-21.5),0.7}
    self.SoundPositions["stopkran_disconnect"] = {60,1e9,Vector(-462.9,-43,-21.5),0.7}	
    ...
    self.SoundPositions["door_alarm"] = {485,1e9,Vector(0,0,0),0.5}	

	self.SoundNames["sf_on"] = "subway_trains/722/switches/sf_on.mp3"
	self.SoundNames["sf_off"] = "subway_trains/722/switches/sf_off.mp3"

	self.SoundNames["door_cab_t_open"] = self.SoundNames["door_cab_open"]
	self.SoundPositions["door_cab_t_open"] = {800,1e9,Vector(-461,17.3,-3.5),0.5}
	self.SoundNames["door_cab_t_close"] = self.SoundNames["door_cab_close"]
	self.SoundPositions["door_cab_t_close"] = {800,1e9,Vector(-461,17.3,-3.5),0.5}
...
function ENT:InitializeSystems()
	...
	self:LoadSystem("RVS","81_760_RVS_1")
...
ENT.Spawner = {
	model = {
		"models/metrostroi_train/81-760/81_760_body.mdl",
	...
	-- version cabine
	{"CabVersion","Кабина","List", CabTexture},
    ...
    {"SpawnMode","Spawner.Common.SpawnMode","List",{"Spawner.Common.SpawnMode.Full","Spawner.Common.SpawnMode.Deadlock","Spawner.Common.SpawnMode.NightDeadlock","Spawner.Common.SpawnMode.Depot"}, nil,function(ent,val,rot,i,wagnum,rclk)
        ...
        if ent._SpawnerStarted~=val then
			...
			ent.Pneumatic.TrainLinePressure = val==3 and 5+math.random() or val==2 and 6.6+math.random()*1.5 or 7.6+math.random()*0.5
			if not ent.SF1 then
    ...
    --{"Optimization","Spawner.760.Optimization","Boolean",false,function(ent,val) print(ent.Owner) ent:SetNW2Bool("Optimization",val) end},
