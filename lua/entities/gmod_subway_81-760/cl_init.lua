...
ENT.ButtonMap["PUR"] = {
    ...
    buttons = {
        ...
        {ID = "CISRestartSet",x=134.7, y=55.4,radius = 15, tooltip = "Перезагрузка БМЦИС",model = {
            model = "models/metrostroi_train/81-760/81_760_button_black.mdl",z=0,
            var="CISRestart",speed=12, vmin=0, vmax=1,
            sndvol = 0.3, snd = function(val) return val and "button_square_on" or "button_square_off" end,sndmin = 80, sndmax = 1e3/3, sndang = Angle(-90,0,0),
        }},
        {ID = "CISRestartKToggle",x=110.5, y=56, w=40,h=20, tooltip="Крышка кнопки Перезагрузки БМЦИСа", model = {
            model = "models/metrostroi_train/81-760/81_760_glass_cap.mdl", ang = 90, z = 3,x=2,y=-13,
            var="CISRestartK",speed=8,min=1,max=0, disable="CISRestartSet",
            sndvol = 1, snd = function(val) return val and "kr_close" or "kr_open" end,
            sndmin = 90, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},		
...
ENT.ButtonMap["BackPPZ"] = {
    pos = Vector(410.162,34.915,12.28), --446 -- 14 -- -0,5
    ang = Angle(0,90,90),
    width = 440,
    height = 440,
    scale = 0.0605,
    ...
    buttons = {
        ...
        {ID = "SF27Toggle",x=61.5+11*16.5, y=213.5, w=34,h=40, tooltip = "SF27"},--двери закр
        ...
        {ID = "!BARSBlock",x=362, y=178, radius=0, model = {
        ...
        {ID = "BARSBlock -",x=331,y=175,w=30,h=40,tooltip="Блокировка неисправных БАРСов: -",model={
            plomb = {var="BARSBlockPl", ID="BARSBlockPl", },
        }},
        {ID = "BARSBlock +",x=361,y=175,w=30,h=40,tooltip="Блокировка неисправных БАРСов: +", model={
            plomb = {var="BARSBlockPl", ID="BARSBlockPl", },
        }},
    }
}
...
ENT.ButtonMap["AB"] = {
    pos = Vector(393,7.8,46.5), --446 -- 14 -- -0,5
    ang = Angle(0,0,90),
    width = 90,
    height = 90,
    scale = 0.0625,
    ...
    buttons = {
        {ID = "ABSet",x=45, y=45, radius=15, tooltip = "АБ",model = {
            model = "models/metrostroi_train/81-760/81_760_button_black.mdl",z=-3,
            var="AB",speed=12, vmin=0, vmax=1,
            sndvol = 0.3, snd = function(val) return val and "button_square_press" or "button_square_release" end,sndmin = 80, sndmax = 1e3/3, sndang = Angle(-90,0,0),
        }},
    }
}
ENT.ButtonMap["VityazButtons2"] = {
	...
	hideseat=0.2,
    buttons = {
        {ID = "VityazTVSet",x=10, y=10, w=15,h=15, tooltip = "Упр ТВ",model = {
			var="VityazTV",speed=16,
        }},
        {ID = "VityazTV1Set",x=10, y=28, w=15,h=15, tooltip = "ТВ1",model = {
			var="VityazTV1",speed=16,
        }},
        {ID = "VityazTV2Set",x=10, y=46, w=15,h=15, tooltip = "ТВ2",model = {
			var="VityazTV2",speed=16,
        }},
        {ID = "VityazPSet",x=10, y=64, w=15,h=15, tooltip = " ",model = {
			var="VityazP",speed=16,
        }},
	}
}
ENT.ButtonMap["VityazButtons"] = {
    pos = Vector(512.95+20.8,1.09,-22.1)+Vector(-41.5,0,17.5),
    ang = Angle(4.9,246,61),
    width = 275,
    height = 200,
    scale = 0.055,
    ...
    buttons = {
        ...
        {ID = "VityazHelpSet",x=255, y=25, w=20,h=20, tooltip = "?",model = {
            var="VityazHelp",speed=16,
        }},
        {ID = "VityazKontrSet",x=255, y=5, w=20,h=20, tooltip = "КОНТР",model = {
...
ENT.ButtonMap["BMCISButtons"] = {
	...
	hideseat=0.2,
    buttons = {
        {ID = "BMCISUpSet",x=0, y=0, w=20,h=20, tooltip = "▲",model = {
            var="BMCISUp",speed=16,
        }},
        {ID = "BMCISDownSet",x=0, y=20, w=20,h=20, tooltip = "▼",model = {
            var="BMCISDown",speed=16,
        }},
        {ID = "BMCISEnterSet",x=0, y=40, w=20,h=20, tooltip = "↵",model = {
            var="BMCISEnter",speed=16,
        }},
        {ID = "BMCISEscSet",x=0, y=60, w=20,h=20, tooltip = "Esc",model = {
            var="BMCISEsc",speed=16,
        }},
        {ID = "BMCISF1Set",x=0, y=80, w=20,h=20, tooltip = "F1",model = {
            var="BMCISF1",speed=16,
        }},
        {ID = "BMCISF2Set",x=0, y=100, w=20,h=20, tooltip = "F2",model = {
            var="BMCISF2",speed=16,
        }},
        {ID = "BMCISF3Set",x=0, y=120, w=20,h=20, tooltip = "F3",model = {
            var="BMCISF3",speed=16,
        }},
        {ID = "BMCISF4Set",x=0, y=140, w=20,h=20, tooltip = "F4",model = {
...
ENT.ButtonMap["SpeedometerButtons"] = {
	...
	hideseat=0.2,
    buttons = {
        {ID = "SpeedometerF3Set",x=0, y=120, w=20,h=20, tooltip = "F3",model = {
...
ENT.ClientProps["PPZ"] = {
	model = "models/metrostroi_train/81-760/81_760_ppz.mdl",
	pos = Vector(0,0,0),
	ang = Angle(0,0,0),	
	hide=2,
}
...
ENT.ClientProps["Salon"] = {
    model = "models/metrostroi_train/81-760/81_760_int.mdl",
...
ENT.ClientProps["mfdu_bkl"] = {
    model = "models/metrostroi_train/81-760/81_760_mfdu_bkl.mdl",
    pos = Vector(0,0,0),--Vector(55.5,0,-54.25),
    ang = Angle(0,0,0),
	hide=2,
	callback = function(ent,cl_ent)
		for k,v in pairs(cl_ent:GetMaterials() or {}) do
			if v == "models/metrostroi_train/81-760/console" and ent:GetNW2Bool("BKL",false) then
				--cl_ent:SetSubMaterial(k-1,"models/metrostroi_train/81-760/console_bkl")
			end
		end	
	end,		
}
ENT.ClientProps["roof_old"] = {
	model = "models/metrostroi_train/81-760/81_760_roof_old.mdl",
	pos = Vector(0,0,0),
	ang = Angle(0,0,0),
	hide = 2,
}
...
ENT.ClientProps["label_bkl"] = {
	model = "models/metrostroi_train/81-760/81_760_label_bkl.mdl",
	pos = Vector(0,0,0),
	ang = Angle(0,0,0),
	hide = 2,
}
...
ENT.ClientProps["door_cab_l"] = {
	...
	hide=2,
	callback = function(ent,cl_ent)
		if ent:GetNW2Bool("BKL",false) then
			cl_ent:SetModel("models/metrostroi_train/81-760/81_760_door_cab_l_bkl.mdl")
			ent:Animate("door_cab_l",ent:GetPackedBool("CabinDoorLeft") and 0.99 or 0.01,0,1, 4, 0.5)
		end
	end,		
}
ENT.ClientProps["door_cab_r"] = {
	...
	callback = function(ent,cl_ent)
		if ent:GetNW2Bool("BKL",false) then
			cl_ent:SetModel("models/metrostroi_train/81-760/81_760_door_cab_r_bkl.mdl")
			ent:Animate("door_cab_r",ent:GetPackedBool("CabinDoorRight") and 0.99 or 0.01,0,1, 4, 0.5)
...
ENT.ClientProps["door_cab_t"] = {
    ...
    pos = Vector(0,0,0),--Vector(-461,17.3,-3.5),
    ang = Angle(0,0,0),--Angle(0,0,-0.15)
}
...
function ENT:Think()
	...
	local stl, bkl = self:GetNW2Bool("STL",true),self:GetNW2Bool("BKL",false)
	self:ShowHide("!NEZ2",stl)
	self:ShowHide("CISRestartSet",bkl)
	self:ShowHide("CISRestartKToggle",bkl)
	self:ShowHide("roof_old",stl)
	self:ShowHide("roof_new",bkl) 
	self:ShowHide("label_bkl",bkl)
	self:ShowHide("label_stl",stl)
	self:HidePanel("AB",stl)
	self:HidePanel("VityazButtons2",bkl)
	self:ShowHide("mfdu_bkl",bkl)
	self:ShowHide("mfdu_stl",stl)
	self:ShowHide("micro",not self:GetNW2Bool("Micro",false))
	
	local RearTrain,mezhvag = self:GetNW2Entity("RearTrain"),self.ClientEnts["mezhvag"]
	...
	if IsValid(mezhvag) and IsValid(RearTrain) and IsValid(RearTrain.ClientEnts["mezhvag"]) and self.ClientEnts["mezhvag"]:GetPos():Distance(RearTrain.ClientEnts["mezhvag"]:GetPos()) < 150 then--and RearTrain:GetClass():find("760") then
		mezhvag:ManipulateBonePosition(0,mezhvag:WorldToLocal(RearTrain:LocalToWorld(Vector(-493.27,0,-15))))-- -489.5 -1.27
		local ang1 = mezhvag:WorldToLocalAngles(RearTrain:LocalToWorldAngles(Angle(0,-90,0)))
		mezhvag:ManipulateBoneAngles(0,Angle(-ang1.r,ang1.y,ang1.p))
	end
	if IsValid(mezhvag) and IsValid(RearTrain) and IsValid(RearTrain.ClientEnts["mezhvag1"]) and self.ClientEnts["mezhvag"]:GetPos():Distance(RearTrain.ClientEnts["mezhvag1"]:GetPos()) < 150 then--and RearTrain:GetClass():find("760") then
		mezhvag:ManipulateBonePosition(0,mezhvag:WorldToLocal(RearTrain:LocalToWorld(Vector(493.27,0,-15))))-- -489.5 -1.27
		local ang1 = mezhvag:WorldToLocalAngles(RearTrain:LocalToWorldAngles(Angle(0,90,0)))
		mezhvag:ManipulateBoneAngles(0,Angle(-ang1.r,ang1.y,ang1.p))
	end
	...
	--ANIMS
    self:Animate("brake_line", self:GetPackedRatio("BL"), 0, 0.857,  256,2)
    self:Animate("train_line", self:GetPackedRatio("TL"), 0, 0.857,  256,2)
	...
	--print(controllerpos[self:GetPackedRatio("Controller")+4])
    self:Animate("controller", controllerpos[self:GetPackedRatio("Controller")+4] or 0, 0, 1,  2,false)
    ...
    local door_cab_t = self:Animate("door_cab_t",self:GetPackedBool("RearDoor") and 1 or 0,0,1, 2, 0.5)
	self:PlayDoorSound(door_cab_t > 0.2,"door_cab_t")
	--[[
	if self.door_cab_t ~= (door_cab_t > 0.2) then
		self.door_cab_t = door_cab_t > 0.2
		self:PlayOnce("door_cab_t_"..(self.door_cab_t and "open" or "close"),"",1,1)
	end
	]]
	...
	--if self.WagonNumber == 37309 then print(self:GetPackedBool("CabinDoorLeft"),door_cab_l) end
	...
	self:ShowHide("stopkran",stopcrane_cap>0)
	self:Animate("stopkran", self:GetPackedBool("stopkran") and 0 or 1, 0, 0.5,  6,false)
	self:HidePanel("stopkran2",stopcrane_cap<1)	 
	
	--box_stopcrane_cap_int
	...
	--self:SetSoundState("rvs1",self:GetPackedBool("RVSButtonsState",false) and 0.5 or 0,1)
...
--[[
    ...
    self:SetSoundState("test_async1", tunstreet*math.Clamp((state)/0.3+0.2,0,1)*strength, 0.95+math.Clamp(state,0,1)*0.05)
	...
	--print(tunstreet*math.Clamp((state)/0.26+0.2,0,1)*strength,speed)
	...
	--draw.VectorSprite( self:GetPos(),20 , Color(255,255,255), true )
	...
	--self:SetSpritePower(1,headl > 0)
	--self:SetSpritePower(2,headl > 0)
end

ENT.Sprites = {
    [1] = { Vector(528  ,   -36, -39.5), Angle(0,0,0), Color(200,240,255,255),scale=10,nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},	
    [2] = { Vector(528  ,   36.5, -39.5), Angle(0,0,0), Color(200,240,255,255),scale=10,nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},	
}
ENT.SpritesEnabled = {}
for _,v in pairs(ENT.Sprites) do
	ENT.SpritesEnabled[v] = false
end

function ENT:SetSpritePower(index,power,brightness)
	local brightness = brightness or 1
	self.SpritesEnabled[index] = power and brightness
end


local function paintsprites(arg)
	cam.Start3D()
		render.SetMaterial(arg.mat)
		render.DrawSprite(arg.position, arg.size, arg.size, arg.color )
	cam.End3D()		
end
function ENT:DrawSprite(num,param,brightness)
	local pos,ang,col,scale,texture = self:LocalToWorld(param[1]),param[2],param[3],param.scale or 1.0,(param.texture and param.texture ~= "" and param.texture or "sprites/light_glow02")
	if Material(texture):IsError() then
		ErrorNoHalt("Texture of client sprite "..num.." is not valid. \n Texture: "..param.texture.."\n")
		return
	end
	--local v = {sprite = texture, color = Color(255, 255, 255, 255),selfillum = false,translucent = false ,alphatest = true, nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false , nolod = false}
	...
	local tocheck = { "selfillum" , "translucent" , "alphatest" , "nocull", "additive", "vertexalpha", "vertexcolor", "ignorez" , "nolod"  }
	...
	local v = {sprite = texture, color = col}	
	...
	--v.createdSprite = v.sprite
    --v.spriteMaterial = CreateMaterial(name,"Sprite_DX8",params)	
	
	cam.Start3D()
		render.SetMaterial(v.spriteMaterial)
		render.DrawSprite(pos,scale*16,scale*16, col)	
	cam.End3D()
	
	--local args = {mat = v.spriteMaterial,position = pos,size = scale*16,color = col}
	--hook.Add("HUDPaint","paintsprites",paintsprites(args))
	--print(hook.Call("HUDPaint"))
	--hook.Run("HUDPaint","paintsprites")
...
function ENT:DrawSprites()
	for k,v in pairs(self.Sprites) do	
		if self.SpritesEnabled[k] then
			self:DrawSprite(k,v,self.SpritesEnabled[k])
		end
	end
end
	...
	for i=1,8 do
		self:DrawOnPanel("BNT"..i,function(...)
			...
			if self:GetNW2Bool("BMCISExtra",false) then
				...
				surface.DrawTexturedRectRotated(512,520,1024,1024,0)
			else
				surface.SetMaterial(self.RTMaterial)
				surface.SetDrawColor(255,255,255,170)
